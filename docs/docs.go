...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/admin.PaginatedResponse"
                        }
                    }
                }
            }
        ...
        "/admin/qrcodes": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter: unregistered | active | blocked",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin.GenerateQRRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/client.patchMeBody"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/client.patchVehicleBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/qr/{qr_id}": {
            ...
            "post": {
                "description": "Claims a QR code for the given phone number.\nIf a user with that phone already exists they are linked to this QR.\nReturns a JWT token pair that the owner uses to edit their profile.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/client.registerBody"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/client.messageBody"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/client.refreshBody"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "client.patchMeBody": {
            ...
            "properties": {
                ...
                "whatsapp": {
                    "description": "Socials: omit = skip, \"\" = delete, \"value\" = upsert",
                    "type": "string"
                }
            }
        },
        "client.patchVehicleBody": {
            "type": "object",
            "properties": {
                "car_model": {
                    "type": "string"
