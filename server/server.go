...
func New() (*Server, error) {
	...
	admin.Get("/me", adminH.GetAdminMe)
	admin.Get("/dashboard", adminH.GetDashboard)
	admin.Get("/dashboard/chart", adminH.GetDashboardChart)

	adminSuper := admin.Group("", middleware.SuperAdminOnly())
	adminSuper.Get("/admins", adminH.ListAdmins)
	adminSuper.Get("/admins/:id", adminH.GetAdmin)
	adminSuper.Post("/admins", adminH.CreateAdmin)
	adminSuper.Patch("/admins/:id", adminH.PatchAdmin)
	adminSuper.Patch("/admins/:id/block", adminH.BlockAdmin)
