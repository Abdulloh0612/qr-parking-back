...
func (r *ScanEventRepo) GetByQRCodeID(ctx context.Context, qrCodeID string, offset, limit int) ([]types.ScanEvent, error) {
...
func (r *ScanEventRepo) CountByQRCodeID(ctx context.Context, qrCodeID string) (int, error) {
	var count int
